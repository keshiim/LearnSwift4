...
let magenta = Color(red: 0.0, green: 1.0, blue: 0.0)
...
let basicRect = Rect()
let originRect = Rect(origin: Point(x: 4.0, y: 4.0), size: Size(width: 5.0, height: 5.0))
...
print("\(recipe.name)   \(recipe.quantity) ")
let food = Food()
print(food.name)
